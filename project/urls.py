import home_app, New_Quiz_App, registration, authorization, history, profile_app, admin_panel_app
...
# admin_panel_app.admin.add_url_rule('/qqq', view_func=admin_panel_app.add_Class, methods = ['POST', 'GET'])
...
history.history.add_url_rule(rule='/history/int:session_od', view_func=history.show_qtr_page, methods= ['POST', 'GET'])
history.history.add_url_rule(rule='/history/int:id/int:user_id', view_func=history.show_qsr_page, methods= ['POST', 'GET'])
...
project.register_blueprint(blueprint=admin_panel_app.admin)

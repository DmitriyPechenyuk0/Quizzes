...
Revision ID: 85364c37ad5c
Revises: 
Create Date: 2025-10-08 18:37:46.993029
...
def upgrade():
    ...
    op.create_table('session_results_participants',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('session_results_participants')

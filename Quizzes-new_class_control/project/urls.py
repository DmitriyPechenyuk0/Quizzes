...
from result import show_result_page, result
from quiz_app.app import quiz
from quiz_app import views as quiz_views, sockets as quiz_sockets
from control.views import control, show_control_page, accept_student, remove_student
from registration.views import show_page_registration, confirm_email
from control.views import get_class_quiz_history
...
control.add_url_rule('/get_class_quiz_history', view_func=get_class_quiz_history, methods=['GET'])
